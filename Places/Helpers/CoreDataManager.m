...
+ (NSManagedObjectContext *)managedObjectContext {
    if (!managedObjectContext) {
        managedObjectContext = [self newManagedObjectContextWithConcurrencyType:NSMainQueueConcurrencyType];
    }
...
+ (NSManagedObjectContext *)backgroundManagedObjectContext {
    if (!backgroundManagedObjectContext) {
        backgroundManagedObjectContext = [self newManagedObjectContextWithConcurrencyType:NSMainQueueConcurrencyType];
    }
